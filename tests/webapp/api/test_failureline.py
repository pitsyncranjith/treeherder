...
def test_update_failure_line_verify(test_repository, failure_lines, classified_failures, test_user):
...
def test_update_failure_line_replace(test_repository, failure_lines, classified_failures, test_user):
...
def test_update_failure_line_mark_job(test_job,
                                      failure_lines,
                                      classified_failures,
                                      test_user):
...
def test_update_failure_line_mark_job_with_auto_note(mock_autoclassify_jobs_true,
                                                     test_job,
                                                     failure_lines,
                                                     classified_failures,
                                                     test_user):
...
def test_update_failure_line_ignore(test_repository, test_job, failure_lines,
                                    classified_failures, test_user):
...
def test_update_failure_line_all_ignore_mark_job(mock_autoclassify_jobs_true,
                                                 test_job,
                                                 failure_lines,
                                                 classified_failures,
                                                 test_user):
...
def test_update_failure_line_partial_ignore_mark_job(mock_autoclassify_jobs_true,
                                                     test_job,
                                                     failure_lines,
                                                     classified_failures,
                                                     test_user):
